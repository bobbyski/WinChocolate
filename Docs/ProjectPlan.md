...
- [ ] per-item images, pull-down display behavior, visual item graying _(needs owner-draw → 8.3)_
...
- [ ] disabling native autorepeat _(native up/down always repeats; niche)_
...
- [ ] borderless breadcrumb visuals _(cosmetic → 8.x)_
