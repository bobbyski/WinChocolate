...
Phase 3 · AppKit Surface Expansion         ████████████████████░░░░░░   76%  🔄 In Progress
...
|---:|---|---|---|---|
| 1 | Demo and controls | Keep moving through the next control surface. | 🔄 In Progress | Latest surface: `NSWindowController` + document window flow (3.9), after gradients/clipping (3.5), ICO (3.13), and undo (3.11). Strong next candidates: find/replace (3.11), split-divider dragging (3.3), and `Timer` (7.6) to unblock the Phase 11 apps. |
...
## Phase 3 — AppKit Surface Expansion 🔄 76%
