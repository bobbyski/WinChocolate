...
- [x] ⤷ template/symbol images and `isEditable`/drag are **their own plan items** — symbols are **3.24**, image formats/template tinting **3.13**, and drag-and-drop **3.18**; they are not 3.1 deliverables
